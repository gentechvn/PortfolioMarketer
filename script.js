...
const tabsConatainer = document.querySelector('.operations__tab-container');
...
tabsConatainer.addEventListener('click', function (e) {
...
//Don't use
logo.className = 'emanuel';
*/

/* const h1 = document.querySelector('h1');

// const alertH1 = function (e) {
//   alert('addEvent listener: Great! your are reading the heading');
// };
...
console.log(h1.nextElementSiblingElementSibling);
